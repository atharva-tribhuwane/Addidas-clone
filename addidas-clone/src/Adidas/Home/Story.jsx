...
const Story = () => {
  return (
    <>
    <div className="'main-wrapper" style={{  backgroundColor: '#e9ecef'}}>
      <div className="artical-wrapper-main">
        <div className="article-div">
          <p className="heading">
            STORIES, STYLES AND SPORTSWEAR AT <br />ADIDAS, SINCE 1949
          </p>
        ...
        <div className="article-div">
          <p className="heading">WORKOUT CLOTHES, FOR ANY SPORT</p>
          <div className="article-text">
