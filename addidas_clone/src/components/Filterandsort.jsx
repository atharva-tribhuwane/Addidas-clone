    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <div onClick={handleDrawerOpen}
                edge="start"
                sx={{ mr: 2, ...(open && { display: 'none' }) }}>Filterandsort</div>
            <Drawer
                sx={{
                    width: drawerWidth,
                    flexShrink: 0,
                    ...
                    <Accordion>
                        ...
                        <AccordionDetails>
                            <ListItem button style={{ textAlign: "start", paddingLeft: "0" }}>
                                ...
                                }} button style={{ textAlign: "start", paddingLeft: "0" }} value="Lifestyle" onChange={(e)=>handleoptionChange(e)}/>
                            ...
                            <ListItem button style={{ textAlign: "start", paddingLeft: "0" }}>
                                ...
                                }} button style={{ textAlign: "start", paddingLeft: "0" }} value="Training" onChange={(e)=>handleoptionChange(e)}/>
                            ...
                            <ListItem button style={{ textAlign: "start", paddingLeft: "0" }}>
                                ...
                                }} button style={{ textAlign: "start", paddingLeft: "0" }} value="Running" onChange={(e)=>handleoptionChange(e)}/>
                            ...
                            <ListItem button style={{ textAlign: "start", paddingLeft: "0" }}>
                                ...
                                }} button style={{ textAlign: "start", paddingLeft: "0" }} value="originals" onChange={(e)=>handleoptionChange(e)}/>
